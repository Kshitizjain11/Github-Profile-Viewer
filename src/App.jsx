 ...
 useEffect(() => {
  ...
  return (
    ...
    <div className="w-full min-h-screen background text-white p-1">
      <Particle>
      <div className='px-36 pt-36 m-10' >
      ...
      <div className="w-[44vw] mt-10 pt-20 flex items-center gap-3 ">
      <h1 className='text-7xl leading-22 tracking-tight inter-font-bold' >A simpler way to show your GitHub profile and repositories.</h1>
      </div>
      <div className=" flex w-[40%] mt-10 justify-between items-center gap-4">
        <input onChange={inputHandler} className=' w-full text-2xl rounded-2xl py-[19px] pl-4 bg-[#283157] focus:bg-amber-50 focus:text-black' value={username}  type="text" name="username"  placeholder='Enter a GitHub username..' />
        <button onClick={buttonClick} className='py-[19px] px-8 rounded-2xl text-2xl  border-[1px] border-[#283157]' >View</button> 
      </div>
      <div className="mt-20">
        <h1 className='text-[#4E5E7E] text-lg inter-font-bold ' >Amazing developers</h1>
        <div className="">Here Comes random</div>
      </div>
      <div className="mt-20">
        <h1 className='text-[#4E5E7E] text-sm inter-font-bold ' >Created by Kshitiz</h1>
      </div>
    </div>
      </Particle>
