...
const Profile = ({data}) => {
  return (
    <div className='w-full bg-gray-200 py-2 px-6 rounded-2xl text-sm md:text-base' >
      ...
      <div className="h-0.5  mt-6 bg-[#adadb5] "></div>
      <div className="text my-6">
        <h3 className='text-sm md:text-base text-black inter-font' >{data.bio || "Bio isn't given"} </h3>
      </div>
      ...
      {data.location && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Location</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.location}</p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      {data.company && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Company</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.company} </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      ...
      {data.email && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Email</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.email} </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      {data.twitter_username && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Twitter</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.twitter_username} </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      {data.following !== undefined && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Following</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.following} </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      {data.followers !== undefined && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Followers</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.followers} </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
      {data.public_repos !== undefined && (
        <>
          <div className="repeatable flex justify-between items-center ">
            <h1 className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' >Repos</h1>
            <p className='text-gray-500 inter-font text-xs md:text-sm tracking-tight' > {data.public_repos}  </p>
          </div>
          <div className="h-0.5  my-5 bg-[#adadb5] "></div>
        </>
      )}
