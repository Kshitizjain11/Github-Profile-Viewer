...
const Navbar = () => {
  return (
    <div className='flex bg-[#787c83] justify-around items-center'>
      <div className="flex justify-between items-center gap-4">
        ...
        <h1 className='text-xl  inter-font-bold ' >GitHub Profile Viewer</h1>
      </div>
      <div className="search p-2">
        <input className='w-full text-xl rounded-xl pr-12 py-[10px] pl-4 bg-[#cacbce] ' type="text" name="username" placeholder='Enter GitHub username..' />
      </div>
    </div>
  )
}
